...
sap.ui.define([
    ...
    "sap/ui/Device",
    "com/demo/zb70jsontable/model/models",
    ...
    function (UIComponent, Device, models, JSONModel) {
        ...
        return UIComponent.extend("com.demo.zb70jsontable.Component", {
            metadata: {
                manifest: "json"
            },
            ...
            init: function () {
                ...
                const sPath = sap.ui.require.toUrl("com/demo/zb70jsontablemodel/data.json");
